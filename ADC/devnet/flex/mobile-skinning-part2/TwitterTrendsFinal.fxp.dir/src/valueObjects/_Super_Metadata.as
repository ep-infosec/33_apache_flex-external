...
public class _Super_Metadata extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal function setterListenerResult_type(value:flash.events.Event):void
    {
        _model.invalidateDependentOnResult_type();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.result_typeIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_result_typeValidationFailureMessages);
        }
    ...
    model_internal var _doValidationCacheOfResult_type : Array = null;
    model_internal var _doValidationLastValOfResult_type : String;

    model_internal function _doValidationForResult_type(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfResult_type != null && model_internal::_doValidationLastValOfResult_type == value)
           return model_internal::_doValidationCacheOfResult_type ;

        _model.model_internal::_result_typeIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isResult_typeAvailable && _internal_result_type == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "result_type is required"));
        }

        model_internal::_doValidationCacheOfResult_type = validationFailures;
        model_internal::_doValidationLastValOfResult_type = value;
