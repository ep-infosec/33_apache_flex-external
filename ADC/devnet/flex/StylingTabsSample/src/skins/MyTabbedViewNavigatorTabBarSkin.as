 ...
 */
public class MyTabbedViewNavigatorTabBarSkin extends ButtonBarSkin
{
    //--------------------------------------------------------------------------
    //
    //  Constructor
     ...
     * 
     */
    public function MyTabbedViewNavigatorTabBarSkin()
    {
        super();
    }
    ...
    override protected function createChildren():void
    {
        if (!firstButton)
        {
            ...
            firstButton.skinClass = MyTabbedViewNavigatorTabBarFirstTabSkin;//HS
        }
