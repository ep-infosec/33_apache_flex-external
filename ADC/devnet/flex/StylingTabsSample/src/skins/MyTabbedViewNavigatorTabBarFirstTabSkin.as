...
import assets.TabbedViewNavigatorButtonBarFirstButton_selected;
import assets.mobile320.TabbedViewNavigatorButtonBarFirstButton_selected;
 ...
 */
public class MyTabbedViewNavigatorTabBarFirstTabSkin extends TabbedViewNavigatorTabBarTabSkinBase
{
    /**
     *  Constructor.
     *  
     ...
     *  @productversion Flex 4.5
     */
    public function MyTabbedViewNavigatorTabBarFirstTabSkin()
    {
        super();
        ...
        switch (applicationDPI)
        {
            case DPIClassification.DPI_320:
            {
				...
				// You could set a different skin for the selected tab by doing something like below...
				//selectedBorderSkin = assets.mobile320.TabbedViewNavigatorButtonBarFirstButton_selected;
                break;
            }
            default:
            {
				...
				// You could set a different skin for the selected tab by doing something like below...
				//selectedBorderSkin = assets.TabbedViewNavigatorButtonBarFirstButton_selected;
                break;
            }
        }
    }
