...
internal class _Super_EmployeeService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_EmployeeService()
    {
        ...
        _serviceControl.source = "TestDrive.services.EmployeeService";
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function deleteEmployee(itemID:Number) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getEmployeesByID(itemID:Number) : mx.rpc.AsyncToken
    {
